...
const SearchInputSection = ({scrolled}:Props) => {
  return (
    <section className={`h-12.5 w-full rounded-[26px] bg-[#FFFFFF]  flex items-center pl-2.5 pr-10.5 gap-3.5
        ${scrolled ? 'scale-[0.98] shadow-lg' : 'scale-100'} 
        `}>
          <div className="flex items-center pl-2 ">
            <SearchIconCs className="w-5.5 h-5.25 "  fill='#000000' fillOpacity='0.35' />
          </div>
